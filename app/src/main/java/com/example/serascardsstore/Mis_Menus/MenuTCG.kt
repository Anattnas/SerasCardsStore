...
class MenuTCG : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Listener para abrir DigiMain
        digitButton.setOnClickListener {
            // Use la ruta completa porque los menus de mis cartas estan en otra carpeta osea en Mis_Menus para que reconozca donde esta
            // Mejor movi MenuTCG a Mis_Menus para tener en orden todo
